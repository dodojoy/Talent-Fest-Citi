...
`;
  ...
  const footer = container.querySelector('.footer-homepage');
  const cardsteste = container.querySelector('.cards-products');

  menu.addEventListener('click', () => {
    const navFilter = container.querySelector('#navFilter');
    navFilter.classList.toggle('active');
    footer.classList.toggle('teste');
    cardsteste.classList.toggle('teste');
  });
