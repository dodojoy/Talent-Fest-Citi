        ...
        <body>
            <div class='wrapper'>
                ...
                <section id='cards-products' class='cards-products'>
                    ...
                    <div class='product-card'>
                        <div class='filtro'>
                            <img src='./assets/foto-andrea.png' alt='Foto da desenvolvedora Andrea,
                                mulher de cabelos ondulados e soltos usando uma blusa verde. 
                    ...
                    <div class='product-card'
                        <div class='filtro'>
                            <img src='./assets/foto-anna.png' alt='Foto da desenvolvedora Anna Clara,
                                uma mulher com cabelos lisos e com franja, usando um colar vermelho e blusa branca.
                                Ela está sorrindo'>
                            <h3>Anna Clara Andrade</h3>
                            <p>Aluna da 8º geração da Laboratória</p>
                            <a href='https://github.com/andradeannac' target='_blank'>
                            <img src='assets/github.png' alt='github'></a>     
                            <a href='https://www.linkedin.com/in/andradeannac/' target='_blank'>
                    ...
                    <div class='product-card'>
                        <div class='filtro'>
                            <img src='./assets/foto-poly.png' alt='Foto da desenvolvedora Polyana, uma mulher com cabelos lisos e soltos,
